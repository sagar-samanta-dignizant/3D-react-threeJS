...
const MenuBar = ({
    ...
    return (
        <nav className='flex flex-col items-center gap-4 p-4 h-full w-12 shadow-lg'>
                ...
                >
                    <MenuItem>
                        <div className='w-40 p-2 space-y-4'>
                            <div className='hue flex flex-col items-start'>
                            ...
                            <div className='saturation flex flex-col items-start'>
                            ...
                            <div className='lightness flex flex-col items-start'>
                                <span className='text-sm font-medium'>Lightness</span>
                                <Slider
                                    aria-label="Scale"
                                    size='small'
